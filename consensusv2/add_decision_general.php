...
<?php
echo mysql_real_escape_string($_POST['decision_name']);
echo mysql_real_escape_string($_POST['description']);
echo $_SESSION['user_id'];
//mysql_query("insert into decision values ('','".mysql_real_escape_string($_POST['e2_id'])."','".$_GET['e1_id']."','".mysql_real_escape_string($_POST['name'])."')");
mysql_query("insert into decision values ('', '".mysql_real_escape_string($_POST['decision_name'])."', '".mysql_real_escape_string($_POST['description'])."', '".$_SESSION['user_id']."', '3','4','1')");
